...
/**
 * Servlet implementation class StackAnalysis
 */
@WebServlet(urlPatterns="/StackAnalysis",asyncSupported=true)
public class StackAnalysis extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		executor.execute(new Runnable() {
			...
			public void run() {
				...
				if (query==null || query=="")
					exec("/home/bijoyan/Documents/ProjectPythonCodes/stackanalyze.py",query,response);
				else
					exec("/home/bijoyan/Documents/ProjectPythonCodes/stackquestions.py",query,response);
			}
		});
	...
	private static void exec(String client,String query,HttpServletResponse response){
		ProcessBuilder pb;
		if (query==null || query=="")
			pb = new ProcessBuilder("./spark-submit", client);
		else
			pb = new ProcessBuilder("./spark-submit", client, query);
