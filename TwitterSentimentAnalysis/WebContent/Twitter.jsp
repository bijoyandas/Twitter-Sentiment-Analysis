...
<body>
	...
	<div id="placement">
		<form name="search" >
			<input  id="cricketerName" type="text" name="hashtag" placeholder="Enter hashtag i.e. #example" style="color:black;padding-top:8px;padding-left:10px;padding-right:10px;padding-bottom:8px;font-size:20px;border-radius:30px"> 
			<input id="buttonStyle" type="button" value="Analyse" onclick="sendInfo()" style="padding-top:7px;padding-bottom:7px;border-radius:30px">
		</form>
	</div>
	<br><br>
	<div id="chartPane">
